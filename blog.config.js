...
const BLOG = {
  ...
  NOTION_PAGE_ID: '2ba3506749f281f99808f6ba1014de2a',
  THEME: 'next', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: 'Lyrics', // 您的昵称 例如 tangly1024
  BIO: 'NEFU CS Sophomore | Acmer', // 作者简介
  AVATAR: '/avatar.jpg', // <-- 新添加的头像路径
  LINK: 'https://notion-next-three-psi-33.vercel.app/', // 网站地址
