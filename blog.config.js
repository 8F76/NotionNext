...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lyrics', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'NEFU CS Sophomore | Acmer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-nu-ten-44.vercel.app/', // 网站地址
